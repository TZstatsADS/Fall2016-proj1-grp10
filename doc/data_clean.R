...
data_final <- data_f
data_all_var <- data_final[!is.na(DIS) & (RAC1P==1|RAC1P==2|RAC1P==3|RAC1P==6) & (SCHL==1|SCHL==16|SCHL==21|SCHL==22|SCHL==24) & !is.na(WAGP) & (VPS==1|VPS==6|VPS==11) & !is.na(MIL), list(DIS, RAC1P, SCHL, WAGP, VPS, MIL, PWGTP, fac)]
